...
import com.example.RemotePatientMonitoringSystem02.repository.agriculture.SmartFarmingRepository;
...
@Service
public class SmartFarmingService {

    private final SmartFarmingRepository smartFarmingRepository;

    public SmartFarmingService(SmartFarmingRepository smartFarmingRepository) {
        this.smartFarmingRepository = smartFarmingRepository;
    }

    public List<SmartFarmingDevices> getAllDevices(){
        return smartFarmingRepository.findAll();
    }

    public BigDecimal calculateTotalInvestment(List<SmartFarmingDevices> devices, List<Integer> quantities, int investmentPeriod) {
        BigDecimal totalInvestment = BigDecimal.ZERO;
        for (int i = 0; i < devices.size(); i++) {
            SmartFarmingDevices device = devices.get(i);
    ...
    public BigDecimal calculateTotalNetBenefit(List<SmartFarmingDevices> devices, List<Integer> quantities, int investmentPeriod) {
