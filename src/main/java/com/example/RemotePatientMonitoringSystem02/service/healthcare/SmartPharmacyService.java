...
import com.example.RemotePatientMonitoringSystem02.repository.healthcare.SmartPharmacyRepository;
...
@Service
public class SmartPharmacyService {

    public final SmartPharmacyRepository smartPharmacyRepository;

    public SmartPharmacyService(SmartPharmacyRepository smartPharmacyRepository) {
        this.smartPharmacyRepository = smartPharmacyRepository;
    }

    public List<SmartPharmacyDevices> getAllDevices(){
        return smartPharmacyRepository.findAll();
    }

    public BigDecimal calculateTotalInvestment(List<SmartPharmacyDevices> devices, List<Integer> quantities, int investmentPeriod) {
        BigDecimal totalInvestment = BigDecimal.ZERO;
        for (int i = 0; i < devices.size(); i++) {
            SmartPharmacyDevices device = devices.get(i);
    ...
    public BigDecimal calculateTotalNetBenefit(List<SmartPharmacyDevices> devices, List<Integer> quantities, int investmentPeriod) {
